...
Register_Class(RecvCallbackMsg);

RecvCallbackMsg::RecvCallbackMsg(const char *name, int kind) : cMessage(name,kind)
{
    this->socketId_var = 0;
    this->name_var = "RecvCallback";
}

RecvCallbackMsg::RecvCallbackMsg(const RecvCallbackMsg& other) : cMessage()
{
    setName(other.getName());
    operator=(other);
}

RecvCallbackMsg::~RecvCallbackMsg()
{
}

RecvCallbackMsg& RecvCallbackMsg::operator=(const RecvCallbackMsg& other)
{
    if (this==&other) return *this;
    cMessage::operator=(other);
    this->socketId_var = other.socketId_var;
...
void RecvCallbackMsg::parsimPack(cCommBuffer *b)
{
    cMessage::parsimPack(b);
    doPacking(b,this->socketId_var);
...
void RecvCallbackMsg::parsimUnpack(cCommBuffer *b)
{
    cMessage::parsimUnpack(b);
    doUnpacking(b,this->socketId_var);
...
int RecvCallbackMsg::getSocketId() const
{
    return socketId_var;
}

void RecvCallbackMsg::setSocketId(int socketId_var)
{
    this->socketId_var = socketId_var;
}

const char * RecvCallbackMsg::getName() const
{
    return name_var.c_str();
}

void RecvCallbackMsg::setName(const char * name_var)
{
    this->name_var = name_var;
}

class RecvCallbackMsgDescriptor : public cClassDescriptor
{
  public:
    RecvCallbackMsgDescriptor();
    virtual ~RecvCallbackMsgDescriptor();
...
Register_ClassDescriptor(RecvCallbackMsgDescriptor);

RecvCallbackMsgDescriptor::RecvCallbackMsgDescriptor() : cClassDescriptor("RecvCallbackMsg", "cMessage")
{
}

RecvCallbackMsgDescriptor::~RecvCallbackMsgDescriptor()
{
}

bool RecvCallbackMsgDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<RecvCallbackMsg *>(obj)!=NULL;
}

const char *RecvCallbackMsgDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int RecvCallbackMsgDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount(object) : 2;
}

unsigned int RecvCallbackMsgDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *RecvCallbackMsgDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int RecvCallbackMsgDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='s' && strcmp(fieldName, "socketId")==0) return base+0;
...
const char *RecvCallbackMsgDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *RecvCallbackMsgDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int RecvCallbackMsgDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    RecvCallbackMsg *pp = (RecvCallbackMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string RecvCallbackMsgDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool RecvCallbackMsgDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *RecvCallbackMsgDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *RecvCallbackMsgDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
